...
export const blogPosts: BlogPostData[] = [
  {
    ...
    excerpt:
      'Artificial intelligence is transforming how we approach software testing. Learn about the latest trends and what they mean for development teams.',
    author: 'Sarah Chen',
  ...
  },
  {
    ...
    excerpt:
      'Integrating automated testing into your CI/CD pipeline can dramatically improve code quality. Here are our top tips for getting it right.',
  ...
  },
  {
    ...
    excerpt:
      'A deep dive into the optimization strategies that helped us dramatically improve test performance for our customers.',
    author: 'Emily Watson',
  ...
  },
  {
    ...
    excerpt:
      "Test coverage metrics are important, but they don't tell the whole story. Learn how to interpret and improve your testing strategy.",
    author: 'David Kim',
  ...
  },
  {
    ...
    excerpt:
      "We analyzed successful testing practices from hundreds of development teams. Here's what we learned about building a quality-first culture.",
  ...
  },
  {
    ...
    excerpt:
      'Everything you need to know about API testing, from basic concepts to advanced strategies for microservices architectures.',
    author: 'James Park',
  ...
  },
  {
    ...
    excerpt:
      'We crunched the numbers on automated testing investments. The results might surprise you.',
    author: 'Sarah Chen',
  ...
  },
  {
    ...
    excerpt:
      'How artificial intelligence is changing the landscape of security testing and vulnerability detection.',
    author: 'Michael Rodriguez',
  ...
  },
  {
    ...
    excerpt:
      'The unique challenges of mobile testing and how to overcome them with the right tools and processes.',
    author: 'Emily Watson',
