...
export const pricingFAQs: FAQItem[] = [
  {
    ...
    answer:
      'A test execution is a single run of any test case in your suite. If you run a test suite with 10 test cases, that counts as 10 executions.',
  },
  {
  ...
  },
  {
    ...
    answer:
      "We'll notify you as you approach your limit. You can either upgrade your plan or purchase additional executions as needed. Tests will continue to run normally.",
  },
  {
  ...
  },
  {
    ...
    answer:
      'We accept all major credit cards (Visa, Mastercard, American Express, Discover) and can arrange invoicing for Enterprise customers.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Yes! We offer special pricing for nonprofits and educational institutions. Contact our sales team to learn more.',
  },
];
